...
public class HomePage extends Base { //This extends Base allows to use all Methods from this class Base
	...
	public void basePageNavigation(String Username, String Password) throws IOException
	{
		...
		ForgotPassword fpa =lop.forgetPassMethod();
		fpa.userEmailForgotPassMethod().sendKeys("something");
		fpa.sendInstructionsMethod().click();
