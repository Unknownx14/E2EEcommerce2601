...
public class HomePageValidates extends Base { //This extends Base allows to use all Methods from this class Base
	...
	public void basePageNavigation() throws IOException
	{
		...
		Assert.assertEquals(lp.featuredCoursesMethod().getText(), "FEATURED COURSES");
	...
	public void validateHeader()
	{
		...
		// Creating an object of this class
		LandingPage lp = new LandingPage(driver);
		Assert.assertEquals(lp.relativeLoc01Method().getText(), "Learn Hot tools like Selenium, Appium, JMeter, SoapUI,Database Testing and more..");
